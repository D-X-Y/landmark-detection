...
CUDA_VISIBLE_DEVICES=${gpus} python main.py \
    --train_list ./cache_data/lists/300W/Light/300w.train.$2 \
    --eval_lists ./cache_data/lists/300W/Light/300w.test.common.$2 \
        	 ...
        	 ./cache_data/lists/300W/Light/300w.test.full.$2 \
                 ./cache_data/lists/300W/Original/300w.test.common.$2 \
        	 ./cache_data/lists/300W/Original/300w.test.challenge.$2 \
        	 ./cache_data/lists/300W/Original/300w.test.full.$2 \
                 ./cache_data/lists/300W/Gray/300w.test.common.$2 \
        	 ./cache_data/lists/300W/Gray/300w.test.challenge.$2 \
        	 ./cache_data/lists/300W/Gray/300w.test.full.$2 \
                 ./cache_data/lists/300W/Sketch/300w.test.common.$2 \
        	 ./cache_data/lists/300W/Sketch/300w.test.challenge.$2 \
        	 ./cache_data/lists/300W/Sketch/300w.test.full.$2 \
    --num_pts 68 --pre_crop_expand 0.2 \
    --arch ${model} --cpm_stage ${stages} \
    --save_path ./snapshots/Light_CPM_${dataset_name}_${model}_${stages}_${epochs}_sigma${sigma}_${height}x${width}x8 \
