...
CUDA_VISIBLE_DEVICES=${gpus} python san_main.py \
    --train_list ./cache_data/lists/300W/Gray/300w.train.$2 \
    --eval_lists ./cache_data/lists/300W/Sketch/300w.test.common.$2 \
    ...
    --cycle_a_lists ./cache_data/lists/300W/Gray/300w.train.$2 \
    --cycle_b_lists ./cache_data/lists/300W/Sketch/300w.test.full.$2 \
