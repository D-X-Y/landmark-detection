...
image_dir = osp.join(os.environ['HOME'], 'datasets', 'landmark-datasets', 'AFLW', 'images')
annot_dir = osp.join(os.environ['HOME'], 'datasets', 'landmark-datasets', 'AFLW', 'annotations')
