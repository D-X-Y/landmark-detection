...
def obtain_StyleDet_args():
  ...
  #parser.add_argument('--use_SI',           action='store_true',        help='use style invariant or not.')
  # GAN Related, we use LSGAN
  ...
  parser.add_argument('--GenNetPath',       type=str,                   help='The checkpoint path for generator.')
  parser.add_argument('--LR_D',             type=float,                 help='The learning rate ratio for the discriminator')
  parser.add_argument('--LR_N',             type=float,                 help='The learning rate ratio for the facial landmark detector')
  ...
  parser.add_argument('--use_tf',           action='store_true',        help='.')
