...
#
#!/usr/bin/env sh
# bash scripts/AFLW-V2/REG-SBR-300VW.sh 0
set -e
echo script name: $0
echo $# arguments
if [ "$#" -ne 1 ] ;then
...
save_path=./snapshots/AFLW/SBR-AFLW.300VW-96x96-${i_batch_size}.${v_batch_size}
rm -rf ${save_path}
...
CUDA_VISIBLE_DEVICES=${gpus} python ./exps/SBR-main.py \
    ...
    --opt_config   ./configs/AFLW-V2/ADAM.REG.300VW.config \
    --sbr_config   ./configs/face/REG/SBR.REG.300VW.W10.config \
