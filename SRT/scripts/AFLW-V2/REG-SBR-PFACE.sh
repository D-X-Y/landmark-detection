...
#
#!/usr/bin/env sh
# bash scripts/AFLW-V2/REG-SBR-PFACE.sh 0
set -e
echo script name: $0
echo $# arguments
if [ "$#" -ne 1 ] ;then
...
save_path=./snapshots/AFLW/SBR-AFLW.PFACE-96x96-${i_batch_size}.${v_batch_size}
rm -rf ${save_path}
...
CUDA_VISIBLE_DEVICES=${gpus} python ./exps/SBR-main.py \
    ...
    --sbr_config   ./configs/face/REG/SBR.REG.AFLW-PFACE.W10.config \
