...
#
#!/usr/bin/env sh
# bash ./scripts/X-300W/REG-300W-SRT-PF-P49.sh 0 W01 W01
echo script name: $0
echo $# arguments
if [ "$#" -ne 3 ] ;then
...
v_batch_size=32
m_batch_size=16
save_path=./snapshots/X-300W/REG-SRT-PF-${opt}.${sbr_w}.${stm_w}-${det}-96x96-${i_batch_size}.${v_batch_size}.${m_batch_size}-P49

#rm -rf ${save_path}

OMP_NUM_THREADS=12 CUDA_VISIBLE_DEVICES=${gpus} python ./exps/STM-main.py \
    ...
    --print_freq 300 --print_freq_eval 2000 --eval_freq 10 --workers 12 \
