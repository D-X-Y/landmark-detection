...
#
#!/usr/bin/env sh
# bash scripts/X-300W/REG-AFLW-SBR-PF.sh 0 W01
echo script name: $0
echo $# arguments
if [ "$#" -ne 2 ] ;then
...
save_path=./snapshots/X-AFLW/REG-SBR-AFLW-PF-${opt}.${sbr_weight}-${det}-96x96-${i_batch_size}.${v_batch_size}
#rm -rf ${save_path}


OMP_NUM_THREADS=12 CUDA_VISIBLE_DEVICES=${gpus} python ./exps/SBR-main.py \
