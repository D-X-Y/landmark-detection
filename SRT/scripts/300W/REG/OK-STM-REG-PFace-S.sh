...
#
#!/usr/bin/env sh
# bash ./scripts/300W/REG/OK-STM-REG-PFace-S.sh 0 W10 16
echo script name: $0
echo $# arguments
if [ "$#" -ne 3 ] ;then
...
v_batch_size=0
m_batch_size=$3
save_path=./snapshots/STM-DEMO-300W.PFaceS.${stm_w}-${det}-REG-96x96-${i_batch_size}.${v_batch_size}.${m_batch_size}
