...
#
#!/usr/bin/env sh
# bash scripts/300VW/HG-R3-256.sh 0
echo script name: $0
echo $# arguments
if [ "$#" -ne 1 ] ;then
...
use_gray=1
batch_size=16
save_dir=./snapshots/300VW/BASE-HG-R3-${det}-256x256-S${sigma}-P49
...
CUDA_VISIBLE_DEVICES=${gpus} python ./exps/BASE-main.py \
    ...
    --num_pts 68 --data_indicator face49-300VW --x68to49 \
    --procedure heatmap --sampler 300W+300VW:16 \
    --model_config ./configs/face/R256/HG-R3.300VW.config \
    --opt_config   ./configs/face/R256/RMSP.HG.300VW.config \
    --save_path ${save_dir} \
    ...
    --print_freq 100 --print_freq_eval 1000 --eval_freq 5 --workers 10 \
